...
bootstrap:
	...
	@ curl -sL https://raw.githubusercontent.com/madx/veil/master/skel/index.jade -o sources/pages/index.jade
	@ $(ECHO) "  sources/pages/index.jade"
	@ curl -sL https://raw.githubusercontent.com/madx/veil/master/skel/stylesheet.styl -o sources/stylesheets/stylesheet.styl
...
upgrade:
	...
	@ curl -sL https://raw.githubusercontent.com/madx/veil/master/Makefile > Makefile
	@ $(ECHO) "$(COL_G)✓ Done$(ENDC)"
